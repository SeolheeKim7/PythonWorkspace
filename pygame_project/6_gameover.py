# Title: Game Over
# Description: Game over when character collides with enemy
# 1. remove all balls (suceess)
# 2. collision with enemy (fail)
# 3. time litmit within 99sec (fail)
...
while running:
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                if ball_img_idx < 3:
                    ...
                    balls.append({
                        ...
                        "init_spd_y": ball_speed_y[ball_img_idx + 1]})
                break
        else:  # continue if the inner loop is not executed
            continue
        break  # continue if the inner loop is executed
    ...
    # if all balls are removed, game over
    if len(balls) == 0:
